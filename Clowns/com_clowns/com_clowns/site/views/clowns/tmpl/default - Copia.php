...
<div align="center">
    ...
    <p> Il clown <span class="nomeClownInMessaggio" ><?php echo $this->nomeClown; ?> (<?php echo $this->nome; echo " "; echo $this->cognome; ?>)</span> &eacute; stato inserito nell'elenco. </p>
</div>
...
<div>
    ...
    <p> Il clown <span class="nomeClownInMessaggio" ><?php echo $this->nomeClown ?></span> &eacute; stato rimosso dall'elenco. </p>
</div>	
...
<div>
    ...
    <p> Il clown <span class="nomeClownInMessaggio" ><?php echo $this->nomeClown ?></span> &eacute; già stato inserito nell'elenco. </p>
</div>	
...
<div>
    ...
    <p> Il clown <span class="nomeClownInMessaggio" ><?php echo $this->nomeClown ?></span> non sembra inserito nell'elenco!! </p>
</div>	
...
<div>
    ...
    <p>Non è stato possibile <?php if($this->messaggio == 'errore-clown-non-aggiunto') {echo 'aggiungere' ;} else if($this->messaggio == 'errore-clow-non-rimosso') {echo 'rimuovere';}?> il clown da te richiesto.</p>
    <p>Forse hai sbagliato qualcosa, ad esempio il nome del clown o la data, per favore controlla e riprova, se il problema persiste contatta l'amministratore </p>
    <p>Grazie!</p>
    <br />
</div>	
<?php endif; ?>
