...
<?php switch($this->messaggio){
	...
	<div align="center">
	    ...
	    <p class="sottoTitoloMessaggio"> Il clown <span class="datiMessaggio" ><?php echo $this->nomeClown; ?> (<?php echo $this->nome; echo " "; echo $this->cognome; ?>)</span> &eacute; stato inserito nell'elenco. </p>
		<br />
	</div>
...
<div>
    ...
    <p class="sottoTitoloMessaggio"> Il clown <span class="datiMessaggio" ><?php echo $this->nomeClown ?></span> &eacute; stato rimosso dall'elenco. </p>
	<br />
</div>
...
<div>
    ...
    <p class="sottoTitoloMessaggio"> Il clown <span class="datiMessaggio" ><?php echo $this->nomeClown ?></span> o la mail <span class="datiMessaggio" ><?php echo $this->mailClown ?></span> sono già stati inseriti nell'elenco. </p>
	<br />
</div>	
...
<div>
    ...
    <p class="sottoTitoloMessaggio"> Il clown <span class="datiMessaggio" ><?php echo $this->nomeClown ?></span> non sembra inserito nell'elenco!! </p>
	<br />
</div>	
...
<div>
    ...
    <p class="sottoTitoloMessaggio"> Devi compilare almeno il campo <span class="datiMessaggio" >Nome clown</span> e la rispettiva <span class="datiMessaggio" >E-mail</span>. </p>
	<br />
</div>	
...
?>
	...
	<p style="margin-bottom: 4px; font-size: 18px;">Nell'elenco sono presenti i seguenti <b><?php echo(sizeOf($nomiClowns));?></b> clown:</p>
...
<!-- 		<span class="hasTip" title="INFORMAZIONI: ::Alberto &lt;br /&gt;Lupoa&lt;br /&gt;lupo.alberto@t.it &lt;br /&gt;320998876"> PROVA</span> -->
		...
		<span class="hasTip" title="INFORMAZIONI : ::
			<?php if($nomiClowns[$n]!=NULL) {echo "<b>".$nomiClowns[$n]."</b>"."&lt;br /&gt;"; }?>
			<?php if($nomi[$n]!=NULL) {echo $nomi[$n]."&lt;br /&gt;"; }?>
			<?php if($cognomi[$n]!=NULL) {echo $cognomi[$n]."&lt;br /&gt;"; }?>
			<?php if($mail[$n]!=NULL) {echo $mail[$n]."&lt;br /&gt;";} ?>
			<?php if($cell[$n]!=NULL) { echo $cell[$n]; }?> 
...
<!-- VISUALIZZA FORM DI GESTIONE-->
	...
	<!-- Aggiunta clown-->
		...
		<div class="formGestione"> 
			...
			<p class="sottoTitoloFormGestione">Inserisci i dati e clicca Aggiungi clown. <br /> Devi inserire almeno il nome clown e la mail.</p>
