...
<?php
	...
	if($nomiClowns == NULL){
		...
		<table>
			<tbody>
			<tr>
				<th>Clown</th> <th>Nome e cognome</th> <th>Indirizzo e-mail</th> <th>Numero di telefono</th>
			</tr>
		...
		<?php
			...
			?> 
				<tr <?php if($n%2==0){echo "class=\"\"";}?>>
					...
					<td><span class="cell"> <?php if($cell[$n]!='0'){echo $cell[$n];} ?></span></td>
