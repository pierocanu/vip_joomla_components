...
class TurniServiziViewgestisci_turni extends JView
{	
	...
	function display($tpl = null){
			...
			$this->FormAggiungiClown = $this->get('FormAggiungiClown');
			$this->FormRimuoviClown = $this->get('FormRimuoviClown');
			$this->FormModificaNote = $this->get('FormModificaNote');
			
			$Info =  $this->info; 
			$this->nomeClown =  $Info[nomeClown];
			$this->giorno =  $Info[giorno];
			$this->mese =  $Info[mese];
